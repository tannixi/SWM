...
def add_args(parser):
    ...
    '''Neural Method Sample YAML LIST:
      ...
      PURE_PURE_UBFC-rPPG_PHYSNET_BASIC
...
def train_and_test(config, data_loader_dict):
    ...
    elif config.MODEL.NAME == 'VSWM':
        model_trainer = trainer.VSWMTrainer.VSWMTrainer(config, data_loader_dict)
    elif config.MODEL.NAME == 'SWM':
        model_trainer = trainer.SWMTrainer.SWMTrainer(config, data_loader_dict)
    elif config.MODEL.NAME == 'SW':
        model_trainer = trainer.SWTrainer.SWTrainer(config, data_loader_dict)
    elif config.MODEL.NAME == 'SM':
        model_trainer = trainer.SMTrainer.SMTrainer(config, data_loader_dict)
    else:
