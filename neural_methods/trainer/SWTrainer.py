...
from neural_methods.model.SW import SW
from neural_methods.trainer.BaseTrainer import BaseTrainer
from tqdm import tqdm


class SWTrainer(BaseTrainer):
    ...
    def __init__(self, config, data_loader):
        ...
        if config.TOOLBOX_MODE == "train_and_test":
            ...
            self.model = SW(frame_depth=self.frame_depth, img_size=128)
            ...
            self.model = SW(frame_depth=self.frame_depth, img_size=128).to(
                self.device)
