...
class PatchMerging(nn.Module):
    ...
    Args:
        ...
        norm_layer (nn.Module, optional): Normalization layer.  Default: nn.LayerNorm
    """
    def __init__(self, dim, norm_layer=nn.LayerNorm, frame_depth=20):
        super().__init__()
        self.dim = dim
    ...
    def forward(self, x):
        ...
        # b,d,h,w,c=x0.shape
        # nt=b*d
        # x0=x0.reshape(nt, h, w, c)
        # x0 = self.TSM_1(x0)
        # x0=x0.reshape(b,d,h,w,c)

        x1 = x[:, :, 1::2, 0::2, :]  # B D H/2 W/2 C
        # x1=x1.reshape(nt, h, w, c)
        # x1 = self.TSM_1(x1)
        # x1 = x1.reshape(b, d, h, w, c)

        x2 = x[:, :, 0::2, 1::2, :]  # B D H/2 W/2 C
        # x2=x2.reshape(nt, h, w, c)
        # x2 = self.TSM_1(x2)
        # x2 = x2.reshape(b, d, h, w, c)

        x3 = x[:, :, 1::2, 1::2, :]  # B D H/2 W/2 C
        # x3=x0.reshape(nt, h, w, c)
        # x3 = self.TSM_1(x3)
        # x3 = x3.reshape(b, d, h, w, c)
